...
import com.john.www.main.testFunction.predicate.ProjectLanguagePredicate;
import com.john.www.main.testFunction.predicate.ProjectPredicate;
import com.john.www.main.testFunction.predicate.ProjectStarPredicate;
...
//        jButton.addActionListener(e -> System.out.println("按钮被按下了"));
        ...
        data.sort(Comparator.comparing(Project::getName));
